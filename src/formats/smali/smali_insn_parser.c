...
static const smali_op_t smali_optab[] = {
    ...
    {0x81, 1, 0, "neg-double"},
    {0x82, 1, 0, "not-double"},
    {0x83, 1, 0, "int-to-long"},
    {0x84, 1, 0, "int-to-float"},
    {0x85, 1, 0, "int-to-double"},
    {0x86, 1, 0, "long-to-int"},
    {0x87, 1, 0, "long-to-float"},
    {0x88, 1, 0, "long-to-double"},
    {0x89, 1, 0, "float-to-int"},
    {0x8A, 1, 0, "float-to-long"},
    {0x8B, 1, 0, "float-to-double"},
    {0x8C, 1, 0, "double-to-int"},
    {0x8D, 1, 0, "double-to-long"},
    {0x8E, 1, 0, "double-to-float"},
    {0x8F, 1, 0, "int-to-byte"},
    {0x90, 1, 0, "int-to-char"},
    {0x91, 1, 0, "int-to-short"},
};
